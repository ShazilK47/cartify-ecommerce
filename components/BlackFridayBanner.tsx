...
const BlackFridayBanner = async () => {
  const sale = await getActiveSaleByCouponCode(COUPON_CODES.CARTIFY70);
    ...
    <div className="bg-gradient-to-r from-red-600 to-black text-white px-6 py-10  mt-2 rounded-lg shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex-1">
          ...
          <div className="flex">
            <div className="bg-white text-black py-4 px-4 sm:px-6 rounded-full shadow-md transform hover:scale-105 transition duration-300 ">
